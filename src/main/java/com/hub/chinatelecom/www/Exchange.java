 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static Exchange parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            Exchange object =
                new Exchange();
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"exchange".equals(type)){
                                ...
                                return (Exchange)com.hub.chinatelecom.www.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
